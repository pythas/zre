...
// pub fn drawLineSegment(self: *Self, line_segment: LineSegment, color: wgpu.Color) void {
//     self.drawLine(
//         @intFromFloat(line_segment.start.x),
//         @intFromFloat(line_segment.start.y),
//         @intFromFloat(line_segment.end.x),
//         @intFromFloat(line_segment.end.y),
//         color,
//     );
// }
